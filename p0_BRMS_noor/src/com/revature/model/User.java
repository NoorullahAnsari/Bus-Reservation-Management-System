...
public class User {
	...
	public String toString() {
		return "User [userId=" + userId + ", username=" + username + ", email=" + email + ", phoneNo=" + phoneNo
				...
				+ ", identityProof=" + identityProof + ", password=" + password + ", age="
				+ age + "]";
	}
	...
	@Override
	public int hashCode() {
		return Objects.hash(address, age, dateOfBirth, email, identityProof, password, phoneNo,
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(address, other.address) && age == other.age
				...
				&& Objects.equals(identityProof, other.identityProof)&& Objects.equals(password, other.password) && Objects.equals(phoneNo, other.phoneNo)
